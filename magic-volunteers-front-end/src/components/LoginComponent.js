...
class LoginComponent extends Component {
  ...
  componentDidMount() {
      ...
      const credentialUtils = new CredentialsUtils();
      credentialUtils.checkStoredCredentialsValid(
        () => { console.log("valid"); },
        () => { this.setState({isLoading:false});}
      );
  }
  ...
  logInHandle = (e) => {
      ...
      const credUtils = new CredentialsUtils();
      ...
      credUtils.logIn(
          ...
          function onSuccess(credentials){
            ...
            if(keepSession === true) cookieDuration = 20; //20 days

            CredentialsUtils.storeCredentials(credentials.userName, credentials.token, cookieDuration);
